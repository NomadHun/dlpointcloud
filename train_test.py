...
parser.add_argument('--test_area', type=int, default=2, help='Which area to use for test, option: 1-6 [default: 2]')
...
room_filelist = [line.rstrip() for line in open('tum_sem_seg_hdf5_data/buildings_filelist.txt')]
...
test_area = 'Building_'+str(FLAGS.test_area)
train_idxs = []
test_idxs = []
